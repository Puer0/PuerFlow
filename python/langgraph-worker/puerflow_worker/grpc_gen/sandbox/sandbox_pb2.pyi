...
class FileReadResponse(_message.Message):
    ...
    size_bytes: int
    file_type: str
    def __init__(self, success: _Optional[bool] = ..., content: _Optional[str] = ..., error: _Optional[str] = ..., size_bytes: _Optional[int] = ..., file_type: _Optional[str] = ...) -> None: ...
...
class FileWriteRequest(_message.Message):
    ...
    encoding: str
    user_id: str
    def __init__(self, session_id: _Optional[str] = ..., path: _Optional[str] = ..., content: _Optional[str] = ..., append: _Optional[bool] = ..., create_dirs: _Optional[bool] = ..., encoding: _Optional[str] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class FileWriteResponse(_message.Message):
    ...
    error: str
    absolute_path: str
    def __init__(self, success: _Optional[bool] = ..., bytes_written: _Optional[int] = ..., error: _Optional[str] = ..., absolute_path: _Optional[str] = ...) -> None: ...
...
class FileListRequest(_message.Message):
    ...
    include_hidden: bool
    user_id: str
    def __init__(self, session_id: _Optional[str] = ..., path: _Optional[str] = ..., pattern: _Optional[str] = ..., recursive: _Optional[bool] = ..., include_hidden: _Optional[bool] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class FileEntry(_message.Message):
    ...
    size_bytes: int
    modified_time: int
    def __init__(self, name: _Optional[str] = ..., path: _Optional[str] = ..., is_file: _Optional[bool] = ..., size_bytes: _Optional[int] = ..., modified_time: _Optional[int] = ...) -> None: ...
...
class FileListResponse(_message.Message):
    ...
    file_count: int
    dir_count: int
    def __init__(self, success: _Optional[bool] = ..., entries: _Optional[_Iterable[_Union[FileEntry, _Mapping]]] = ..., error: _Optional[str] = ..., file_count: _Optional[int] = ..., dir_count: _Optional[int] = ...) -> None: ...
...
class FileSearchRequest(_message.Message):
    ...
    include: str
    context_lines: int
    def __init__(self, session_id: _Optional[str] = ..., query: _Optional[str] = ..., path: _Optional[str] = ..., max_results: _Optional[int] = ..., regex: _Optional[bool] = ..., include: _Optional[str] = ..., context_lines: _Optional[int] = ...) -> None: ...
...
class FileSearchResponse(_message.Message):
    ...
    matches_found: int
    truncated: bool
    def __init__(self, success: _Optional[bool] = ..., matches: _Optional[_Iterable[_Union[SearchMatch, _Mapping]]] = ..., error: _Optional[str] = ..., files_scanned: _Optional[int] = ..., matches_found: _Optional[int] = ..., truncated: _Optional[bool] = ...) -> None: ...
...
class FileEditRequest(_message.Message):
    ...
    new_text: str
    replace_all: bool
    def __init__(self, session_id: _Optional[str] = ..., path: _Optional[str] = ..., old_text: _Optional[str] = ..., new_text: _Optional[str] = ..., replace_all: _Optional[bool] = ...) -> None: ...
...
class FileEditResponse(_message.Message):
    ...
    snippet: str
    file_size_after: int
    def __init__(self, success: _Optional[bool] = ..., error: _Optional[str] = ..., replacements: _Optional[int] = ..., snippet: _Optional[str] = ..., file_size_after: _Optional[int] = ...) -> None: ...
...
class CommandResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[bool] = ..., stdout: _Optional[str] = ..., stderr: _Optional[str] = ..., exit_code: _Optional[int] = ..., error: _Optional[str] = ..., execution_time_ms: _Optional[int] = ...) -> None: ...
...
class FileDeleteRequest(_message.Message):
    ...
    pattern: str
    recursive: bool
    def __init__(self, session_id: _Optional[str] = ..., path: _Optional[str] = ..., pattern: _Optional[str] = ..., recursive: _Optional[bool] = ...) -> None: ...
...
class FileDeleteResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[bool] = ..., error: _Optional[str] = ..., deleted_count: _Optional[int] = ..., deleted_paths: _Optional[_Iterable[str]] = ...) -> None: ...

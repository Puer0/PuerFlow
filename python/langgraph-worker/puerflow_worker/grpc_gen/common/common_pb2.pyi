...
class TaskMetadata(_message.Message):
    ...
    max_agents: int
    token_budget: float
    def __init__(self, task_id: _Optional[str] = ..., user_id: _Optional[str] = ..., session_id: _Optional[str] = ..., tenant_id: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., labels: _Optional[_Mapping[str, str]] = ..., max_agents: _Optional[int] = ..., token_budget: _Optional[float] = ...) -> None: ...
...
class ExecutionMetrics(_message.Message):
    ...
    agents_used: int
    mode: ExecutionMode
    def __init__(self, latency_ms: _Optional[int] = ..., token_usage: _Optional[_Union[TokenUsage, _Mapping]] = ..., cache_hit: _Optional[bool] = ..., cache_score: _Optional[float] = ..., agents_used: _Optional[int] = ..., mode: _Optional[_Union[ExecutionMode, str]] = ...) -> None: ...

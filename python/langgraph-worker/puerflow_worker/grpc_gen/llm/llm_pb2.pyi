...
class GenerationConfig(_message.Message):
    ...
    enable_caching: bool
    cache_key: str
    def __init__(self, temperature: _Optional[float] = ..., top_p: _Optional[float] = ..., max_tokens: _Optional[int] = ..., stop_sequences: _Optional[_Iterable[str]] = ..., presence_penalty: _Optional[float] = ..., frequency_penalty: _Optional[float] = ..., enable_caching: _Optional[bool] = ..., cache_key: _Optional[str] = ...) -> None: ...
...
class ToolDefinition(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., parameters_schema: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., requires_confirmation: _Optional[bool] = ...) -> None: ...
...
class GenerateCompletionResponse(_message.Message):
    ...
    cache_hit: bool
    finish_reason: str
    def __init__(self, completion: _Optional[str] = ..., tool_calls: _Optional[_Iterable[_Union[_common_pb2.ToolCall, _Mapping]]] = ..., usage: _Optional[_Union[_common_pb2.TokenUsage, _Mapping]] = ..., model_used: _Optional[str] = ..., provider: _Optional[_Union[Provider, str]] = ..., cache_hit: _Optional[bool] = ..., finish_reason: _Optional[str] = ...) -> None: ...
...
class ModelInfo(_message.Message):
    ...
    available: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., provider: _Optional[_Union[Provider, str]] = ..., tier: _Optional[_Union[_common_pb2.ModelTier, str]] = ..., context_window: _Optional[int] = ..., cost_per_1k_prompt_tokens: _Optional[float] = ..., cost_per_1k_completion_tokens: _Optional[float] = ..., supports_tools: _Optional[bool] = ..., supports_streaming: _Optional[bool] = ..., available: _Optional[bool] = ...) -> None: ...

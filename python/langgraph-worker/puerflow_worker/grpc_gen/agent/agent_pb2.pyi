...
class AgentConfig(_message.Message):
    ...
    def __init__(self, max_iterations: _Optional[int] = ..., timeout_seconds: _Optional[int] = ..., enable_sandbox: _Optional[bool] = ..., memory_limit_mb: _Optional[int] = ..., enable_learning: _Optional[bool] = ...) -> None: ...
...
class HealthCheckResponse(_message.Message):
    ...
    def __init__(self, healthy: _Optional[bool] = ..., message: _Optional[str] = ..., uptime_seconds: _Optional[int] = ..., active_tasks: _Optional[int] = ..., memory_usage_percent: _Optional[float] = ...) -> None: ...
...
class DiscoverToolsRequest(_message.Message):
    ...
    max_results: int
    def __init__(self, query: _Optional[str] = ..., categories: _Optional[_Iterable[str]] = ..., tags: _Optional[_Iterable[str]] = ..., exclude_dangerous: _Optional[bool] = ..., max_results: _Optional[int] = ...) -> None: ...

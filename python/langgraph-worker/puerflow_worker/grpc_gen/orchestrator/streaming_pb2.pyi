...
class TaskUpdate(_message.Message):
    ...
    seq: int
    stream_id: str
    def __init__(self, workflow_id: _Optional[str] = ..., type: _Optional[str] = ..., agent_id: _Optional[str] = ..., message: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., seq: _Optional[int] = ..., stream_id: _Optional[str] = ...) -> None: ...

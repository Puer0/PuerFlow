...
class GetTaskStatusRequest(_message.Message):
    ...
    def __init__(self, task_id: _Optional[str] = ..., include_details: _Optional[bool] = ...) -> None: ...
...
class ApproveTaskRequest(_message.Message):
    ...
    modified_action: str
    approved_by: str
    def __init__(self, approval_id: _Optional[str] = ..., workflow_id: _Optional[str] = ..., run_id: _Optional[str] = ..., approved: _Optional[bool] = ..., feedback: _Optional[str] = ..., modified_action: _Optional[str] = ..., approved_by: _Optional[str] = ...) -> None: ...
...
class PendingApproval(_message.Message):
    ...
    def __init__(self, approval_id: _Optional[str] = ..., workflow_id: _Optional[str] = ..., query: _Optional[str] = ..., proposed_action: _Optional[str] = ..., reason: _Optional[str] = ..., requested_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class GetControlStateResponse(_message.Message):
    ...
    cancel_reason: str
    cancelled_by: str
    def __init__(self, is_paused: _Optional[bool] = ..., is_cancelled: _Optional[bool] = ..., paused_at: _Optional[str] = ..., pause_reason: _Optional[str] = ..., paused_by: _Optional[str] = ..., cancel_reason: _Optional[str] = ..., cancelled_by: _Optional[str] = ...) -> None: ...
...
class UpdateScheduleRequest(_message.Message):
    ...
    def __init__(self, schedule_id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., cron_expression: _Optional[str] = ..., timezone: _Optional[str] = ..., task_query: _Optional[str] = ..., task_context: _Optional[_Mapping[str, str]] = ..., max_budget_per_run_usd: _Optional[float] = ..., timeout_seconds: _Optional[int] = ..., clear_task_context: _Optional[bool] = ...) -> None: ...
...
class UpdateScheduleResponse(_message.Message):
    ...
    message: str
    next_run_at: str
    def __init__(self, success: _Optional[bool] = ..., message: _Optional[str] = ..., next_run_at: _Optional[str] = ...) -> None: ...
...
class SubmitReviewDecisionRequest(_message.Message):
    ...
    approved_by: str
    research_brief: str
    def __init__(self, workflow_id: _Optional[str] = ..., approved: _Optional[bool] = ..., final_plan: _Optional[str] = ..., conversation: _Optional[str] = ..., approved_by: _Optional[str] = ..., research_brief: _Optional[str] = ...) -> None: ...

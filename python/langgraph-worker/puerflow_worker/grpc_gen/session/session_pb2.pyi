...
class CreateSessionResponse(_message.Message):
    ...
    message: str
    def __init__(self, session_id: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., expires_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., status: _Optional[_Union[_common_pb2.StatusCode, str]] = ..., message: _Optional[str] = ...) -> None: ...
...
class GetSessionRequest(_message.Message):
    ...
    def __init__(self, session_id: _Optional[str] = ..., include_history: _Optional[bool] = ...) -> None: ...
...
class UpdateSessionResponse(_message.Message):
    ...
    status: _common_pb2.StatusCode
    message: str
    def __init__(self, success: _Optional[bool] = ..., new_expires_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., status: _Optional[_Union[_common_pb2.StatusCode, str]] = ..., message: _Optional[str] = ...) -> None: ...
...
class DeleteSessionResponse(_message.Message):
    ...
    status: _common_pb2.StatusCode
    message: str
    def __init__(self, success: _Optional[bool] = ..., status: _Optional[_Union[_common_pb2.StatusCode, str]] = ..., message: _Optional[str] = ...) -> None: ...
...
class ListSessionsRequest(_message.Message):
    ...
    limit: int
    offset: int
    def __init__(self, user_id: _Optional[str] = ..., active_only: _Optional[bool] = ..., limit: _Optional[int] = ..., offset: _Optional[int] = ...) -> None: ...
...
class AddMessageResponse(_message.Message):
    ...
    status: _common_pb2.StatusCode
    message: str
    def __init__(self, success: _Optional[bool] = ..., history_size: _Optional[int] = ..., status: _Optional[_Union[_common_pb2.StatusCode, str]] = ..., message: _Optional[str] = ...) -> None: ...
...
class ClearHistoryRequest(_message.Message):
    ...
    session_id: str
    keep_context: bool
    def __init__(self, session_id: _Optional[str] = ..., keep_context: _Optional[bool] = ...) -> None: ...
...
class SessionSummary(_message.Message):
    ...
    total_tokens: int
    is_active: bool
    def __init__(self, id: _Optional[str] = ..., user_id: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_active: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., message_count: _Optional[int] = ..., total_tokens: _Optional[int] = ..., is_active: _Optional[bool] = ...) -> None: ...
...
class Message(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., role: _Optional[str] = ..., content: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., tokens_used: _Optional[int] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
